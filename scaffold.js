    ...
    function replacePlaceholders(dir) {
      for (const file of fs.readdirSync(dir)) {
        ...
        if (stat.isDirectory()) {
          ...
          content = content
            .replace(/warehouseMover/g, appName)
            .replace(/Puris/g, publisher)
            .replace(/WarehouseMover/g, bcPageName)
            .replace(/91d11b0f-857c-472e-90db-df6bb1c1d1b6/g, tenantID)
            .replace(/50260/g, idStartRange)
            .replace(/50261/g, idEndRange)
            .replace(/b7bdd432-f9ce-4575-944b-5e894013ad69/g, appID);
